...
backsub_dp.py, backsub_dp_c.c, backsub_dp_cl.c, backsub_dp_cl.cl - The background subtraction code.
...
test_backsub_dp.py, test_deinterlace_ev.py, test_five_word.py, test_half.py, test_light_correct_ms.py, test_opticalflow_lk.py, test_read_cv.py, test_view_cv.py, test_write_cv.py - Various test scripts. Good place to start if figuring out how to use this module.
