...
// Set of methods for accessing the data about learners...
...
extern const LearnerType * LearnerSummary[];
...
int LearnerSet_optimise(InfoSet * info, IndexView * view, int features, int depth, float improve, unsigned int key[4]);
...
typedef int (*DoTest)(void * test, DataMatrix * dm, int exemplar);

// Code to test table for tests - allows you to get at the functions for each test...
extern const DoTest CodeToTest[256];
