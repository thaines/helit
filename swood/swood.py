...
class SWood:
  ...
  def __init__(self, int_dm, real_dm, cat, tree_count = 128, option_count = 3, weight = None, index = None, callback = None):
    ...
    for itr in xrange(tree_count):
      ...
      dt = DecTree(int_dm, real_dm, cat, weight, bootstrap, option_count)
  ...
  def tree_list(self):
    """Returns a list of all the decision trees in the woodland."""
    return self.trees
