...
hst (GNU Affero GPL 3.0) - Handwriting synthesis tool; the second GUI. Does exactly what you would expect - lets you synthesise handwriting. Contains the core synthesis code that brings the modules togteher to make it work. Run with 'python main.py'.
